...
///CategoryOverflowCalendarDayView2
///
...
class CategoryOverflowCalendarDayView2<T extends Object> extends StatefulWidget
    implements CalendarDayView<T> {
  const CategoryOverflowCalendarDayView2({
    Key? key,
  ...
  @override
  State<CategoryOverflowCalendarDayView2<T>> createState() =>
      _CategoryOverflowCalendarDayView2State<T>();
}

class _CategoryOverflowCalendarDayView2State<T extends Object>
    extends State<CategoryOverflowCalendarDayView2<T>> {
